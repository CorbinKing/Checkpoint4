...
namespace BlowOut.Controllers
{
    public class ClientsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "clientID,clientFirstName,clientLastName,clientAddress,clientCity,clientState,clientZip,clientEmail,clientPhone")] Clients clients)
        {
            if (ModelState.IsValid)
            {
